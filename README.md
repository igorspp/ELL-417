<h1 id="introduction-to-bioinformatics-for-microbiologists--day-6---introduction-to-metagenomics--r">Introduction to bioinformatics for microbiologists:  Day 6 - Introduction to metagenomics &amp; R</h1>
